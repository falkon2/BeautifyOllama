...
import { askOllama, listOllamaModels } from "@/app/services/ollamaService";
...
import { MessageSquare, Bot, User, Plus, MoreHorizontal, Menu, Sun, Moon } from "lucide-react";
...
export default function Chat() {
  ...
  useEffect(() => {
    listOllamaModels().then((availableModels) => {
        ...
        <div className="flex-1 overflow-y-auto p-2">
          {conversations.map((conversation) => (
            <button
              ...
              className={`w-full text-left p-3 rounded-lg mb-2 hover:bg-accent active:bg-accent/80 transition-colors touch-manipulation ${
